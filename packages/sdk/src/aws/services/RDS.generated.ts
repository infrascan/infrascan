...
async function performScan(
  ...
  try {
    ...
    do {
      const DescribeDBInstancesCmd = new DescribeDBInstancesCommand(
        {} as DescribeDBInstancesCommandInput,
      );
      const result: DescribeDBInstancesCommandOutput = await RDS.send(
        DescribeDBInstancesCmd,
      );
      const formattedResult = Formatters.RDS.describeDBInstances(result);
      DescribeDBInstancesState.push({
