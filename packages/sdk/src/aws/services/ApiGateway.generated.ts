...
async function performScan(
  ...
  try {
    ...
    do {
      const GetDomainNamesCmd = new GetDomainNamesCommand(
        {} as GetDomainNamesCommandInput,
      );
      const result: GetDomainNamesCommandOutput = await ApiGatewayV2.send(
        GetDomainNamesCmd,
      );
      const formattedResult = Formatters.ApiGatewayV2.getDomainNames(result);
      GetDomainNamesState.push({
        _metadata: { account, region },
        _parameters: {},
        _result: formattedResult,
      });
